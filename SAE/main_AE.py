...
#python main_AE.py --pretrain_epochs 10 --ref_data_dir /home/kevin/autoencoder/SAE/dataset/timeseries_midi_dataset_all.mat --batch_size 256 --latent_dim 130 --model_name "AE" --maxNum_epochs 100 --patience 100